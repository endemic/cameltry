package {
	...
	public class GameState extends Sprite {
		...
		public function update(e:Event = null):void {
			...
			if (keys[0x25] || keys[0x41]) player.angle += 10;
			if (keys[0x26] || keys[0x57]) player.angle += 10;
			if (keys[0x27] || keys[0x44]) player.angle -= 10;
			if (keys[0x28] || keys[0x53]) player.angle -= 10;
		...
		public function menu_state(e:MouseEvent = null):void {
			destroy();
			this.parent.addChild(new MenuState);
